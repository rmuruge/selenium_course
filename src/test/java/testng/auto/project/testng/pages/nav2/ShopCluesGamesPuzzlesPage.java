...
public class ShopCluesGamesPuzzlesPage extends Page {

	public ShopCluesGamesPuzzlesPage(WebDriver d) {
		super(d);
		// TODO Auto-generated constructor stub
	}
	
	static Logger log = Logger.getLogger(ShopCluesGamesPuzzlesPage.class);
