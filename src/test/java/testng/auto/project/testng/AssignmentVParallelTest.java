...
public class AssignmentVParallelTest extends TestNgTestBase {

	static Logger log = Logger.getLogger(AssignmentVParallelTest.class);
	public AssignmentVParallelTest() {
